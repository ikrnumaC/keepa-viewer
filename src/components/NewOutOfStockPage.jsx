...
const NewOutOfStockPage = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const baseUrl = 'https://yh546hgz2b.execute-api.ap-southeast-2.amazonaws.com/prod/products/new-out-of-stock';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">新品在庫なし商品</h1>
...
export default NewOutOfStockPage;
